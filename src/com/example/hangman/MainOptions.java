...
public class MainOptions extends SelectLanguage {
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	Log.i("tag1", "entro Mainoption");
    	//Log.i("HEY", selected);
    	/*** Sound  ***/ 
    	bg = MediaPlayer.create(MainOptions.this, R.raw.background);
    	
    	bt = MediaPlayer.create(MainOptions.this, R.raw.button);
    	wr = MediaPlayer.create(MainOptions.this, R.raw.warning);
    	ex = MediaPlayer.create(MainOptions.this, R.raw.exit);
    	/**************/ 
    ...
    public void start(View view){
    	bg.pause();
        bt.start();
    	Intent intent = new Intent(MainOptions.this, SelectLanguage.class);
